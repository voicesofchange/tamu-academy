        ...
        {AREAS.map((area, i) => (
          ...
          >
            <span
              ...
              style={{ display: 'block', color: '#e8b85b', fontSize: '1.6rem', fontWeight: 400, opacity: 0.45, marginBottom: '0.85rem', lineHeight: 1 }}
            >
              {area.n}
            </span>
            <h3
              className="font-heading"
              style={{ color: '#f8f0df', fontSize: '1.2rem', fontWeight: 500, margin: '0 0 0.75rem', lineHeight: 1.25 }}
            >
              {area.title}
            </h3>
            <p
              className="font-body"
              style={{ color: 'rgba(243,234,216,0.68)', fontSize: '0.9rem', lineHeight: 1.75, fontWeight: 300, margin: '0 0 1.25rem', flexGrow: 1 }}
            >
              {area.desc}
            </p>
            <Link
              ...
              className="font-body"
              style={{ color: 'rgba(232,184,91,0.7)', fontSize: '0.68rem', letterSpacing: '0.14em', textTransform: 'uppercase', textDecoration: 'none', fontWeight: 500, display: 'inline-flex', alignItems: 'center', gap: '0.4rem' }}
            >
