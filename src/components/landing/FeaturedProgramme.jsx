    ...
    >
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          ...
          {/* Status badge */}
          <span className="font-body" style={{ display: 'inline-block', color: 'rgba(232,184,91,0.85)', fontSize: '0.65rem', letterSpacing: '0.16em', textTransform: 'uppercase', fontWeight: 500, border: '1px solid rgba(232,184,91,0.3)', borderRadius: '999px', padding: '0.3rem 0.85rem', marginBottom: '1.25rem' }}>
            Proposed Pilot Programme
          </span>

          <h2 className="font-heading" style={{ color: '#f8f0df', fontSize: 'clamp(1.7rem, 4vw, 2.75rem)', fontWeight: 400, lineHeight: 1.15, margin: '0 0 0.75rem', maxWidth: '720px' }}>
            Tamu Intercultural AI Leadership Lab
          </h2>

          <p className="font-heading" style={{ color: 'rgba(232,184,91,0.82)', fontSize: 'clamp(1rem, 2vw, 1.25rem)', fontWeight: 300, fontStyle: 'italic', lineHeight: 1.6, margin: '0 0 1.5rem', maxWidth: '600px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0, 2fr) minmax(0, 1fr)', gap: '3rem', alignItems: 'start' }} className="featured-prog-grid">
          ...
          >
            <p className="font-body" style={{ color: 'rgba(243,234,216,0.78)', fontSize: '0.97rem', lineHeight: 1.85, fontWeight: 300, marginBottom: '1.5rem' }}>
            ...
            <p className="font-body" style={{ color: 'rgba(243,234,216,0.62)', fontSize: '0.93rem', lineHeight: 1.8, fontWeight: 300, fontStyle: 'italic', marginBottom: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.85rem', alignItems: 'center' }}>
              <Link
                ...
                style={{
                  ...
                  color: '#24150f', backgroundColor: '#e8b85b',
                  fontSize: '0.72rem', letterSpacing: '0.18em', textTransform: 'uppercase',
                  textDecoration: 'none', fontWeight: 500,
                  border: '1px solid #e8b85b', borderRadius: '2px', padding: '0.65rem 1.3rem',
                }}
              >
              ...
              <Link
                to="/programmes"
                className="font-body"
                style={{ color: 'rgba(243,234,216,0.55)', fontSize: '0.72rem', letterSpacing: '0.16em', textTransform: 'uppercase', textDecoration: 'none', fontWeight: 500 }}
              >
                View All Programmes →
              </Link>
            </div>
          ...
          <motion.div
            ...
            style={{ padding: '1.75rem', border: '1px solid rgba(232,184,91,0.28)', borderRadius: '4px', backgroundColor: 'rgba(232,184,91,0.03)' }}
          >
            ...
            <p className="font-heading" style={{ color: '#f8f0df', fontSize: 'clamp(1rem, 1.8vw, 1.2rem)', fontWeight: 400, fontStyle: 'italic', lineHeight: 1.65, margin: 0 }}>
