    ...
    >
      <div style={{ maxWidth: '680px', margin: '0 auto', textAlign: 'center' }}>
        ...
        >
          <span
            className="font-body"
            style={{ color: '#e8b85b', fontSize: '0.62rem', letterSpacing: '0.2em', textTransform: 'uppercase', fontWeight: 500, display: 'block', marginBottom: '0.9rem' }}
          >
            Institutions
          </span>
          <h2
            className="font-heading"
            style={{ color: '#f8f0df', fontSize: 'clamp(1.35rem, 2.8vw, 1.9rem)', fontWeight: 400, lineHeight: 1.25, margin: '0 0 1rem' }}
          >
            Learning for Institutions
          </h2>
          <div
            aria-hidden="true"
            style={{ width: '48px', height: '1px', background: 'linear-gradient(90deg, transparent, #e8b85b 35%, #E2B652 50%, #e8b85b 65%, transparent)', margin: '0 auto 1.25rem' }}
          />
          <p
            className="font-body"
            style={{ color: 'rgba(243,234,216,0.68)', fontSize: '0.95rem', lineHeight: 1.8, fontWeight: 300, margin: '0 0 1.75rem' }}
          >
