    ...
    >
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          ...
          <h2 className="font-heading" style={{ color: '#f8f0df', fontSize: 'clamp(1.5rem, 3vw, 2.2rem)', fontWeight: 400, lineHeight: 1.25, margin: '0 0 1.25rem' }}>
            Where Tamu Academy Is Now
          </h2>

          <p className="font-body" style={{ color: 'rgba(243,234,216,0.72)', fontSize: '0.97rem', lineHeight: 1.85, fontWeight: 300, margin: 0 }}>
