  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2 className="font-heading" style={{ color: '#f8f0df', fontSize: 'clamp(1.6rem, 3.5vw, 2.4rem)', fontWeight: 400, lineHeight: 1.2, margin: '0 0 1.5rem' }}>
          Founded by Tex Wambui
        </h2>

        <p className="font-body" style={{ color: 'rgba(243,234,216,0.78)', fontSize: '0.97rem', lineHeight: 1.85, fontWeight: 300, marginBottom: '1.75rem' }}>
