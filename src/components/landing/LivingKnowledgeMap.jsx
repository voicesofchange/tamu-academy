    ...
    >
      ...
      <style>{`
        ...
        .lkm-node-btn:focus-visible .lkm-node-ring {
          box-shadow: 0 0 0 3px rgba(232,184,91,0.85);
          border-color: rgba(232,184,91,0.9) !important;
        }
      `}</style>
      ...
      >
        <p
          className="font-body"
          style={{ color: '#e8b85b', fontSize: '0.65rem', letterSpacing: '0.22em', textTransform: 'uppercase', fontWeight: 500, marginBottom: '1rem' }}
        >
        ...
        <h2
          ...
          style={{ color: '#f8f0df', fontSize: 'clamp(1.6rem, 3.5vw, 2.4rem)', fontWeight: 400, lineHeight: 1.2, margin: '0 0 1.25rem', maxWidth: '620px' }}
        >
          Knowledge does not exist in isolation.
        </h2>
        <p
          className="font-body"
          style={{ color: 'rgba(243,234,216,0.72)', fontSize: 'clamp(0.92rem, 1.4vw, 1.05rem)', lineHeight: 1.85, fontWeight: 300, maxWidth: '620px', margin: 0 }}
        >
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                backgroundColor: 'rgba(232,184,91,0.07)',
                ...
                >
                  <div
                    ...
                    style={{
                      ...
                      borderRadius: '50%',
                      border: isActive ? '1.5px solid rgba(232,184,91,0.75)' : '1px solid rgba(232,184,91,0.28)',
                      backgroundColor: isActive ? 'rgba(232,184,91,0.12)' : 'rgba(26,19,14,0.82)',
                  ...
                  >
                    <span
                      className="font-body"
                      style={{
                        color: isActive ? '#E2B652' : 'rgba(243,234,216,0.82)',
                        fontSize: '0.58rem',
                        lineHeight: 1.35,
          ...
          <div
            ...
            style={{
              ...
              border: activeNode ? '1px solid rgba(232,184,91,0.2)' : '1px solid transparent',
              borderRadius: '4px',
              backgroundColor: activeNode ? 'rgba(232,184,91,0.03)' : 'transparent',
          ...
          >
            {activeNode ? (
              <>
                <p className="font-body" style={{ color: '#e8b85b', fontSize: '0.62rem', letterSpacing: '0.18em', textTransform: 'uppercase', fontWeight: 500, margin: '0 0 0.5rem' }}>
                  {activeNode.shortLabel}
                </p>
                <p className="font-body" style={{ color: 'rgba(243,234,216,0.78)', fontSize: '0.9rem', lineHeight: 1.75, fontWeight: 300, margin: '0 0 0.85rem' }}>
                  {activeNode.desc}
                </p>
                <button
                  ...
                  style={{
                    ...
                    color: '#e8b85b', fontSize: '0.68rem', letterSpacing: '0.18em',
              ...
              <p className="font-body" style={{ color: 'rgba(243,234,216,0.35)', fontSize: '0.82rem', fontWeight: 300, margin: 0, paddingTop: '1rem' }}>
      ...
      {isMobile && (
        ...
        >
          <p className="font-body" style={{ color: 'rgba(243,234,216,0.45)', fontSize: '0.75rem', letterSpacing: '0.1em', textTransform: 'uppercase', fontWeight: 500, marginBottom: '1.25rem', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              ...
              return (
                <button
                  ...
                  style={{
                    width: '100%',
                    background: 'none',
                    border: `1px solid ${isActive ? 'rgba(232,184,91,0.45)' : 'rgba(232,184,91,0.16)'}`,
                    borderRadius: '4px',
                    cursor: 'pointer',
                    ...
                    gap: '0.75rem',
                    backgroundColor: isActive ? 'rgba(232,184,91,0.06)' : 'rgba(243,234,216,0.02)',
                    transition: 'all 0.2s ease',
                  }}
                >
                  <span className="font-body" style={{ color: isActive ? '#E2B652' : 'rgba(243,234,216,0.85)', fontSize: '0.88rem', fontWeight: isActive ? 500 : 400, lineHeight: 1.35 }}>
                    {node.shortLabel}
                  </span>
                  <span
                    aria-hidden="true"
            ...
            {NODES.map((node) => {
              ...
              return (
                ...
                >
                  <p className="font-body" style={{ color: 'rgba(243,234,216,0.78)', fontSize: '0.9rem', lineHeight: 1.75, fontWeight: 300, margin: '0 0 1rem' }}>
                    {node.desc}
                  </p>
                  <button
                    onClick={() => navigate('/programmes#learning-areas')}
                    ...
                    style={{
                      background: 'none', border: 'none', cursor: 'pointer',
                      color: '#e8b85b', fontSize: '0.7rem', letterSpacing: '0.18em',
                      textTransform: 'uppercase', fontWeight: 500, padding: 0,
                    }}
                  >
                    Explore all Learning Areas →
