        ...
        <>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <button type="button" disabled={!allComplete || completionPending || progress.moduleCompleted} onClick={handleCompleteModule} className="font-body"
              style={{ ...completeButtonBase, color: allComplete && !completionPending && !progress.moduleCompleted ? '#24150f' : 'rgba(243,234,216,0.4)', backgroundColor: allComplete && !completionPending && !progress.moduleCompleted ? '#e8b85b' : 'rgba(232,184,91,0.15)', cursor: allComplete && !completionPending && !progress.moduleCompleted ? 'pointer' : 'not-allowed' }}>
