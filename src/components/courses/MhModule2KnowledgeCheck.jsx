...
/**
 * MhModule2KnowledgeCheck — renders the Module 2 "Mental Health,
 * Community and Culture" knowledge check for an authorized
 * administrator during development.
 *
 * PRIVACY & TRUST:
 *   - The component renders only the public `quiz` block returned by
 *     `getMentalHealthModule`: heading, subtitle, learner
 *     instruction, privacy notice, passing score, and questions
 *     (id, prompt, options). No correctAnswerIndex or feedback
 ...
 *     selectedIndex }] }.
 *   - The grader creates NO QuizAttempt, ModuleProgress, or
 *     CourseEnrollment record, and triggers no completion,
 *     certificate, payment, enrollment, or analytics event. The
 *     knowledge check is ungraded for module completion.
...
export default function MhModule2KnowledgeCheck({ courseSlug, moduleSlug, quiz }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} aria-label="Module 2 knowledge check">
