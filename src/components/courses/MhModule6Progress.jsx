        ...
        <>
          ...
          <div style={{ marginTop: '1.5rem' }}>
            <button type="button" disabled={!allFiveComplete || completionPending || progress.moduleCompleted} onClick={handleCompleteModule} className="font-body"
              style={{ ...completeButtonBase, color: allFiveComplete && !completionPending && !progress.moduleCompleted ? '#24150f' : 'rgba(243,234,216,0.4)', backgroundColor: allFiveComplete && !completionPending && !progress.moduleCompleted ? '#e8b85b' : 'rgba(232,184,91,0.15)', cursor: allFiveComplete && !completionPending && !progress.moduleCompleted ? 'pointer' : 'not-allowed' }}>
