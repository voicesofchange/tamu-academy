...
/**
 * MhModule3KnowledgeCheck — renders the Module 3 knowledge check.
 * Same architecture as MhModule2KnowledgeCheck: server-side grading
 * via checkMentalHealthKnowledgeCheck, no answer key in the browser,
 * no QuizAttempt/ModuleProgress/CourseEnrollment record created during
 * preview. The only difference is the aria-label.
 */
export default function MhModule3KnowledgeCheck({ courseSlug, moduleSlug, quiz, onGraded }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} aria-label="Module 3 knowledge check">
