...
export default function MhModule7KnowledgeCheck({ courseSlug, moduleSlug, quiz, onGraded }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} aria-label="Module 7 knowledge check">
      ...
      {result && (
        <div role="status" aria-live="polite" style={{ marginTop: '1.5rem', padding: '1.2rem 1.4rem', border: `1px solid ${result.passed ? 'rgba(212,161,42,0.5)' : 'rgba(245,239,224,0.3)'}`, borderRadius: '4px', backgroundColor: 'rgba(245,239,224,0.02)' }}>
          <p className="font-body" style={{ ...bodyText, margin: 0, marginBottom: '0.5rem', color: '#F5EFE0', fontWeight: 500, fontSize: '1.1rem' }}>{result.passed ? quiz.passedMessage : quiz.notPassedMessage}</p>
