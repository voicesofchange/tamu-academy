...
const CONTENT = {
  ...
  heroHeading: 'Learning Should Help Us Understand the World and One Another.',
  heroSubheading: 'Tamu Academy is a diaspora-rooted online learning platform that develops expert-led courses with subject-matter experts, educators, researchers, and knowledge holders.',
  whyHeading: 'Why Tamu Academy Exists',
  whyP1: 'Tamu Academy is a diaspora-rooted online learning platform. It develops courses with subject-matter experts and knowledge holders, providing instructional design, editorial review, production, accessibility, publishing, and distribution so that expert knowledge reaches learners wherever they are.',
  whyP2: 'Serious conversations about public policy, economics, governance, culture, wellbeing, and global affairs are often concentrated in universities, professional institutions, and exclusive networks. Tamu Academy works to change that — making these conversations more accessible to learners from different educational, cultural, and socioeconomic backgrounds.',
  whyP3: 'Courses may serve individuals, facilitated cohorts, universities, institutions, and community organizations. Free videos and articles provide an open-learning entry point for anyone ready to begin.',
  pillarsHeading: 'Three Pillars of Learning',
  pillarsIntro: "Tamu Academy organises its learning around three interconnected areas that reflect what young people most need to understand in order to navigate and shape the world around them.",
  pillars: [
    { name: 'Mind and Wellbeing', desc: 'Understanding ourselves — mental health, identity, achievement, and what it means to live and learn well.' },
    { name: 'Power and Policy', desc: 'Understanding how public decisions are made, whose interests they serve, and how communities can influence change.' },
    { name: 'World and Culture', desc: 'Understanding global systems, cultural diversity, and the forces that connect and divide people across the world.' },
  ],
  pillarsOutro: "These pillars are reflected in Tamu Academy's current video collection, developing courses, and the expert-led learning experiences under preparation.",
  missionEyebrow: 'Mission',
  missionQuote: 'Tamu Academy expands access to interdisciplinary learning that helps young people think critically, communicate across differences, and lead responsibly in their communities and the wider world.',
  visionEyebrow: 'Vision',
  visionQuote: 'A world in which young people from every background can access the knowledge, relationships, and confidence needed to help shape a more peaceful, inclusive, and sustainable future.',
  ...
  approachIntro: "Tamu Academy's learning model draws on a range of methods that emphasise participation, dialogue, and real-world relevance. Learning may include:",
  approachMethods: [
  ...
  diasporaHeading: 'Diaspora Roots and Global Perspective',
  diasporaP1: 'Tamu Academy is rooted in a diaspora understanding of community, knowledge, responsibility, and connection. The name Tamu — meaning sweet in Swahili — reflects a belief that learning should be nourishing, not punishing; that knowledge should serve communities, not merely credentialise individuals.',
  diasporaP2: 'The diaspora is not a single culture. It is a global community of extraordinary cultural, linguistic, geographic, and intellectual diversity — home to thousands of languages, communities, and traditions of knowledge and governance. Tamu Academy draws inspiration from that diversity while engaging with learners and issues from across the world.',
...
export default function About() {
  const { content: c } = useTranslatedContent('about', CONTENT);
  ...
  return (
    <PageLayout>
      ...
      {/* Why Tamu Exists */}
      <PageSection heading={c.whyHeading}>
        <p className={bodyTextClass} style={bodyText}>{c.whyP1}</p>
        <p className={bodyTextClass} style={bodyText}>{c.whyP2}</p>
        <p className={bodyTextClass} style={bodyText}>{c.whyP3}</p>
      </PageSection>
      ...
      <PageSection heading={c.pillarsHeading}>
        ...
        <p className={bodyTextClass} style={bodyText}>{c.pillarsOutro}</p>
      </PageSection>
      ...
      {/* Guiding Principles */}
      <PageSection heading={c.principlesHeading}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '1.1rem' }}>
          {c.principles.map(({ title, desc }, i) => (
            <motion.div
              key={title}
      ...
      {/* Diaspora Roots */}
      <PageSection heading={c.diasporaHeading}>
        <p className={bodyTextClass} style={bodyText}>{c.diasporaP1}</p>
        <p className={bodyTextClass} style={bodyText}>{c.diasporaP2}</p>
        <p className={bodyTextClass} style={bodyText}>{c.diasporaP3}</p>
      </PageSection>
