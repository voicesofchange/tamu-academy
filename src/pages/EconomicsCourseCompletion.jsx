...
const CONTENT = {
  ...
  intro: 'This page reviews your progress across all six modules of {courseTitle}. When every module is complete, you will be able to generate your certificate of completion.',
  ...
  completedAll: 'You have completed all six modules. You are eligible to receive your certificate of completion.',
  ...
  recapBody: "Across six modules, you explored scarcity and choice, how African economies actually work, inflation and employment, trade and debt, inequality and institutions, and Africa's economic futures.",
  recapDisclaimer: 'This course provided general educational information about economics and the global system. It does not constitute professional financial, investment, or policy advice.',
  ...
  certPrivacy: 'Private reflections, activity responses, knowledge check answers, and any other learner writing are not included in the certificate. The certificate confirms course completion only.',
  certEyebrow: 'Certificate',
  certHeading: 'Certificate of Completion',
  eligibleMsg: 'You have completed all six modules. You are eligible to receive your certificate of completion for {courseTitle}.',
  viewCertificate: 'View Your Certificate',
  notEligibleMsg: 'Your certificate will be available once you have completed all six modules.',
  modulesRemaining: 'Modules remaining',
  backToModule: 'Back to Module 6',
};

export default function EconomicsCourseCompletion() {
  const { content: c } = useTranslatedContent('econ-completion', CONTENT);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const res = await base44.functions.invoke('getEconomicsCourseCompletion', { courseSlug: COURSE_SLUG });
        if (cancelled) return;
        if (res && res.data) {
