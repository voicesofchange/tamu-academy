...
/**
 * Module 2 — How African Economies Actually Work.
 * Mirrors the Module 1 page: full learning content in the builder/preview (or
 * for an authenticated admin in production); public production traffic sees the
 * approved "Module in development" state instead.
 */
export default function Module2Economics() {
