...
export const MENTAL_HEALTH_MODULE_5_LESSON = {
  ...
  pathwaysLab: {
    ...
    sectionS: {
      ...
      sustainabilityDecisionLabel: 'SUSTAINABILITY DECISION',
      sustainabilityDecisionPrompt: 'What must remain funded and accountable before continuation or expansion?',
    },
    redTeamTests: {
      ...
      summaryHeading: 'Red Team the Partnership',
      summaryFields: [
        { id: 'rt-most-serious', label: 'MOST SERIOUS RISK', prompt: 'Which harm is most plausible and who would bear it?' },
        { id: 'rt-correction', label: 'CORRECTION', prompt: 'What rule, funding, relationship, or oversight change reduces the risk?' },
        { id: 'rt-accountability', label: 'ACCOUNTABILITY', prompt: 'Who verifies that the correction happened?' },
      ],
    },
    ninetyDayPlan: {
    ...
    partnershipCharter: {
      ...
      fields: [
        { id: 'charter-name', label: 'NAME AND PURPOSE', prompt: 'Use an original name and state the coordination problem in one sentence.' },
        { id: 'charter-partners', label: 'PARTNERS AND ROLES', prompt: "Name each partner's allowed tasks, limits, supervision, and support." },
        { id: 'charter-rights', label: 'RIGHTS PROMISE', prompt: 'State the shared rights floor in plain language.' },
        { id: 'charter-referral', label: 'REFERRAL PROMISE', prompt: 'Explain routine, medicine safety, safeguarding, and urgent pathways.' },
        { id: 'charter-governance', label: 'GOVERNANCE PROMISE', prompt: 'Explain community, youth, and lived experience authority.' },
        { id: 'charter-evidence', label: 'EVIDENCE PROMISE', prompt: 'State what the partnership will measure and will not overclaim.' },
      ],
    },
    completionChecklist: {
      heading: 'Completion Checklist',
      items: [
        'Used a fictional or composite setting and no personal health information',
        'Mapped several support sources without treating them as identical',
        'Centered preference, voluntary participation, and meaningful choice',
        'Defined roles, boundaries, training, supervision, compensation, and accountability',
        'Established one rights standard across community and professional settings',
        'Mapped routine, safeguarding, medicine safety, and urgent referral',
        'Included consent based information sharing and follow up',
        'Gave youth and lived experience partners real authority and support',
        'Selected measures for access, respect, referral, safety, equity, and provider support',
        'Completed the red team, ninety day plan, and partnership charter',
      ],
    },
    finalReminder:
